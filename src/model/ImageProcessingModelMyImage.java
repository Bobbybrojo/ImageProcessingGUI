 ...
 */
public class ImageProcessingModelMyImage implements ImageProcessingModel {
  protected final Map<String, MyImage> images;

  /**
   * Creates an image processing model my image object with a new images hashmap.
   */
  public ImageProcessingModelMyImage() {
  ...
  protected void checkImage(MyImage image) {
    if (image == null) {
